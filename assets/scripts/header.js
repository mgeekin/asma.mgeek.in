function loadHeader() {
    ...
    siteheading.append(gen("span", "sitetitle", gen(a, 'homelink', "Archana School of Music and Arts")));
    homelink.href = 'https://asma.mgeek.in';
    siteheading.append(gen("span", "sitesubtitle", ""));
...
document.title = 'Archana School of Music and Arts'